// =============================================================================
// FMP Income Statement API Route — Proxy for income statement data
// GET /api/fmp/income-statement/{symbol}?period={period}&limit={limit}
// =============================================================================

import { NextRequest, NextResponse } from 'next/server';
import { getIncomeStatement, FMPError, ApiSchemaError, NetworkError, RateLimitedError } from '@/services/api';
...
export async function GET(
  ...
  try {
    ...
    // Call the service
    const statements = await getIncomeStatement(symbol.toUpperCase(), period, limit);
    ...
    console.error('[FMP Income Statement Route] Unexpected error:', error);
    return NextResponse.json(
