// =============================================================================
// FMP Balance Sheet API Route — Proxy for balance sheet data
// GET /api/fmp/balance-sheet/{symbol}?period={period}&limit={limit}
// =============================================================================

import { NextRequest, NextResponse } from 'next/server';
import { getBalanceSheet, FMPError, ApiSchemaError, NetworkError, RateLimitedError } from '@/services/api';
...
export async function GET(
  ...
  try {
    ...
    // Call the service
    const sheets = await getBalanceSheet(symbol.toUpperCase(), period, limit);
    ...
    console.error('[FMP Balance Sheet Route] Unexpected error:', error);
    return NextResponse.json(
